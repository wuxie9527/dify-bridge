"""simplify_memory_tables

Revision ID: e95c28e05186
Revises: fdbc8b4f31e6
Create Date: 2026-05-19 11:18:46.306889
...
revision: str = 'e95c28e05186'
down_revision: Union[str, Sequence[str], None] = 'fdbc8b4f31e6'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_solution_history_solved_at'), 'solution_history', ['solved_at'], unique=False)


def downgrade() -> None:
    """恢复旧表结构"""
    # 删除新表
    op.drop_index(op.f('ix_solution_history_solved_at'), table_name='solution_history')
    op.drop_index(op.f('ix_solution_history_error_code'), table_name='solution_history')
    op.drop_table('solution_history')
